...
dataset = MyDatasetOptimized(data_dir='/home/yongjian/Knot_Data',max_length=1000,dropout=0)
...
def save_checkpt(model,loss, optimizer, epoch, acc,scheduler):
    torch.save({'epoch': epoch,
            ...
            'loss': loss}, '/home/zzhang/Flexible_knot_id/L1000/checkpt/Transformer_model_{}_epoch_{}_acc_{:.4f}.pt'.format(time.strftime('%Y%m%d_%H%M%S'), int(epoch), acc)) 
